 ...
 * @author 232.933573
 */
public class TelaInicialSDI extends javax.swing.JFrame {

    /**
     * Creates new form TelaInicialSDI
     */
    public TelaInicialSDI() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaInicialSDI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaInicialSDI().setVisible(true);
            }
        });
    }
